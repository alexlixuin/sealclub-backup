...
import { getRelatedProducts, getSpecificProductImage, getProductCategories, generateSizeInfo } from "@/lib/products"
    ...
    <div className="container py-10">
            ...
            <Table>
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>{product.purity || "≥99% (HPLC)"}</TableCell>
                </TableRow>
                <TableRow>
      ...
      <div className="mt-12 p-6 bg-muted rounded-lg">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <Button
            onClick={() => {
              // This will be handled by the client component wrapper
              if (typeof window !== "undefined" && window.$crisp) {
                window.$crisp.push(["do", "chat:open"])
                window.$crisp.push(["set", "message:text", `I have a question about ${product.name}`])
              }
            }}
            size="lg"
